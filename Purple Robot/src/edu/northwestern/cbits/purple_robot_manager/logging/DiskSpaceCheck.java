            ...
            if (cache != null) {
                ...
                if (free < DiskSpaceCheck.ERROR_SIZE) {
                    ...
                    this._errorMessage = context
                            .getString(R.string.name_sanity_disk_space_local_error);
                } else if (free < DiskSpaceCheck.WARNING_SIZE) {
                    this._errorLevel = SanityCheck.WARNING;
                    this._errorMessage = context
                            .getString(R.string.name_sanity_disk_space_local_warning);
                }
            }
            ...
            if (this._errorMessage == null && externalCache != null) {
                try {
                    ...
                    if (free < DiskSpaceCheck.ERROR_SIZE) {
                        this._errorLevel = SanityCheck.ERROR;
                        this._errorMessage = context
                                .getString(R.string.name_sanity_disk_space_external_error);
                    } else if (free < DiskSpaceCheck.WARNING_SIZE) {
                        this._errorLevel = SanityCheck.WARNING;
                        this._errorMessage = context
                                .getString(R.string.name_sanity_disk_space_external_warning);
                    }
