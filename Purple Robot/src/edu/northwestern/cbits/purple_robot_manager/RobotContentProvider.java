...
public class RobotContentProvider extends ContentProvider {
    ...
    public final static Uri RECENT_PROBE_VALUES = Uri.parse("content://"
            + AUTHORITY + "/" + RECENT_PROBE_VALUES_TABLE);
    public final static Uri SNAPSHOTS = Uri.parse("content://" + AUTHORITY
            + "/" + SNAPSHOTS_TABLE);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        case RobotContentProvider.RECENT_PROBE_VALUE_LIST:
            result = db.delete(RobotContentProvider.RECENT_PROBE_VALUES_TABLE,
                    selection, selectionArgs);
            break;
        case RobotContentProvider.SNAPSHOT_LIST:
            result = db.delete(RobotContentProvider.SNAPSHOTS_TABLE, selection,
                    selectionArgs);
            break;
        }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        case RobotContentProvider.SNAPSHOT_LIST:
            ...
            long id = db.insert(RobotContentProvider.SNAPSHOTS_TABLE, null,
                    values);
    ...
    public boolean onCreate() {
        ...
        this._uriMatcher.addURI(RobotContentProvider.AUTHORITY,
                RobotContentProvider.RECENT_PROBE_VALUES_TABLE,
        ...
        this._uriMatcher.addURI(RobotContentProvider.AUTHORITY,
                RobotContentProvider.SNAPSHOTS_TABLE,
        ...
        this._openHelper = new SQLiteOpenHelper(this.getContext(),
                RobotContentProvider.DATABASE, null,
            ...
            public void onUpgrade(SQLiteDatabase db, int oldVersion,
                ...
                switch (oldVersion) {
                case 0:
                    db.execSQL(me.getContext().getString(
                            R.string.create_recent_probe_values_sql));
                case 1:
                    db.execSQL(me.getContext().getString(
                            R.string.create_snapshots_sql));
                case 2:
                    db.execSQL(me.getContext().getString(
                            R.string.db_update_snapshots_add_audio));
                default:
                    break;
                }
            }
    ...
    public int updateOrInsert(Uri uri, ContentValues values, String selection,
        ...
        case RobotContentProvider.RECENT_PROBE_VALUE:
            ...
            if (c.getCount() == 0) {
                db.insert(RobotContentProvider.RECENT_PROBE_VALUES_TABLE, null,
                        values);
                count = 1;
            } else
                count = this.update(RobotContentProvider.RECENT_PROBE_VALUES,
        ...
        case RobotContentProvider.SNAPSHOT:
            ...
            if (c.getCount() == 0) {
                ...
                count = this.update(RobotContentProvider.SNAPSHOTS, values,
                        selection, selectionArgs);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        try {
            ...
            case RobotContentProvider.RECENT_PROBE_VALUE_LIST:
                result = db.update(
                        RobotContentProvider.RECENT_PROBE_VALUES_TABLE, values,
                        selection, selectionArgs);

                if (result == 0) {
                    db.insert(RobotContentProvider.RECENT_PROBE_VALUES_TABLE,
                            null, values);
                ...
                break;
            case RobotContentProvider.RECENT_PROBE_VALUE:
                result = this.updateOrInsert(uri, values,
                        this.buildSingleSelection(selection),
                        this.buildSingleSelectionArgs(uri, selectionArgs));
                break;

            case RobotContentProvider.SNAPSHOT_LIST:
                result = db.update(RobotContentProvider.SNAPSHOTS_TABLE,
                        values, selection, selectionArgs);

                if (result == 0) {
                    db.insert(RobotContentProvider.SNAPSHOTS_TABLE, null,
                            values);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        case RobotContentProvider.RECENT_PROBE_VALUE_LIST:
            return db
                    .query(RobotContentProvider.RECENT_PROBE_VALUES_TABLE,
                            projection, selection, selectionArgs, null, null,
                            sortOrder);
        case RobotContentProvider.RECENT_PROBE_VALUE:
            return db.query(RobotContentProvider.RECENT_PROBE_VALUES_TABLE,
                    projection, this.buildSingleSelection(selection),
                    this.buildSingleSelectionArgs(uri, selectionArgs), null,
                    null, sortOrder);
        case RobotContentProvider.SNAPSHOT_LIST:
            return db.query(RobotContentProvider.SNAPSHOTS_TABLE, projection,
