...
{
	public static final Uri CONTENT_URI = Uri.parse("content://edu.northwestern.cbits.purple_robot_manager.distances/distances");
	...
	public boolean onCreate() 
	{
		...
		this._openHelper = new SQLiteOpenHelper(this.getContext(), DistancesProvider.TABLE_NAME, null, DistancesProvider.DATABASE_VERSION)
		{
