...
public class SchemeEngine extends BaseScriptEngine {
    ...
    public Object evaluateSource(String source) {
        ...
        eval.getInteractionEnvironment().setValue(Symbol.intern("PurpleRobot"),
                this);
        eval.getInteractionEnvironment().setValue(Symbol.intern("JSONHelper"),
                new JSONHelper());
        JScheme scheme = new JScheme(eval);

        try {
            scheme.load(new InputStreamReader(this._context.getAssets().open(
                    "scheme/pregexp.scm")));
        } catch (IOException e) {
        ...
        if (pair.isEmpty() == false) {
            ...
            if (first instanceof Pair) {
                ...
                if (value instanceof Pair) {
                    ...
                    if (valuePair.first() instanceof String
                            && valuePair.rest() instanceof Pair) {
            ...
            if (rest instanceof Pair) {
                ...
                Map<String, Object> restMap = SchemeEngine
                        .parsePairList(restPair);
            ...
            if (first instanceof Pair) {
                ...
                if (firstFirst instanceof String) {
                    ...
                    if (second instanceof String)
                        ...
                        if (secondPair.first().toString()
                                .equalsIgnoreCase("begin"))
                            b.putString(key, secondPair.toString());
                        else
                            b.putBundle(key,
                                    SchemeEngine.bundleForPair(secondPair));
                    }
                }
            }
    ...
    public void showNativeDialog(String title, String message,
            String confirmTitle, String cancelTitle, Pair confirmAction,
            Pair cancelAction) {
        this.showNativeDialog(title, message, confirmTitle, cancelTitle,
                confirmAction.toString(), cancelAction.toString());
    }
    ...
    public void emitReading(String name, Object value) {
        ...
        if (value instanceof String)
            ...
            if (value != null)
                Log.e("PRM",
                        "SCHEME PLUGIN GOT UNKNOWN CLASS " + value.getClass());
        }
    ...
    public boolean updateWidget(final String title, final String message,
            final String applicationName, final Pair launchParams,
            final String script) {
    ...
    public void fetchLabels(String appContext, String instructions,
            final Pair labels) {
        super.fetchLabels(appContext, instructions,
                SchemeEngine.parsePairList(labels));
    }
    ...
    public Pair dateToComponents(Date date) {
        ...
        return new Pair(year, new Pair(month, new Pair(day, new Pair(hour,
                new Pair(minute, new Pair(second, null))))));
    }
