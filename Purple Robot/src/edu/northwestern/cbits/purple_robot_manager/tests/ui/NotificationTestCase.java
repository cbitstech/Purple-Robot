    ...
    public void test() {
        ...
        try {
            ...
            BaseScriptEngine.runScript(this._context,
                    "PurpleRobot.cancelScriptNotification();");
            ...
            value = (NativeJavaObject) BaseScriptEngine.runScript(
                    this._context, "PurpleRobot.fetchString('Dialog-Gone')");

            Assert.assertNotNull("NOT0002", value);
            Assert.assertEquals("NOT0003", "Y", value.unwrap());

            BaseScriptEngine.runScript(this._context,
                    "PurpleRobot.persistString('Dialog-Gone', 'N');");
            Thread.sleep(1000);
            ...
            value = (NativeJavaObject) BaseScriptEngine.runScript(
                    this._context, "PurpleRobot.fetchString('Dialog-Hide')");
