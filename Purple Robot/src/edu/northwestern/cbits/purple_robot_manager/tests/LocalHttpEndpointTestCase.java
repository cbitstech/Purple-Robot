...
public class LocalHttpEndpointTestCase extends RobotTestCase {
    ...
    public void test() {
        ...
        try {
            ...
            command.put("script", "PurpleRobot.persistString('plus-test', '"
                    + LocalHttpEndpointTestCase.PLUS_STRING + "');");
            ...
            Assert.assertEquals("LHE3", LocalHttpEndpointTestCase.PLUS_STRING,
