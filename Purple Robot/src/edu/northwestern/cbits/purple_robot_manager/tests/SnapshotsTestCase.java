...
public class SnapshotsTestCase extends RobotTestCase 
{
	...
	public void test() 
	{
		...
		NativeJavaObject snapId = (NativeJavaObject) BaseScriptEngine.runScript(this._context, "PurpleRobot.takeSnapshot('Snapshot Test');");
		...
		NativeObject snapshot = (NativeObject) BaseScriptEngine.runScript(this._context, "PurpleRobot.fetchSnapshot('" + testId + "');");
