...
public abstract class RobotTestCase extends AndroidTestCase 
{
	...
	public String syncHttpPost(String url, Map<String, String> payload) throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException, KeyManagementException, UnrecoverableKeyException, URISyntaxException
	{
