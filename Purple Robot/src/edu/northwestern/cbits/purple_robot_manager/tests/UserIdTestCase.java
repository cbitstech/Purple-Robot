...
public class UserIdTestCase extends RobotTestCase {
    ...
    public void test() {
        ...
        try {
            ...
            Assert.assertEquals("UID2", UserIdTestCase.TEST_ID_1,
                    engine.fetchUserId());
            ...
            Assert.assertEquals("UID3", UserIdTestCase.TEST_ID_2,
                    engine.fetchUserId());
            ...
            command.put("script", "PurpleRobot.setUserId('"
                    + UserIdTestCase.TEST_ID_1 + "');");

            HashMap<String, String> payload = new HashMap<String, String>();
            payload.put("json", command.toString(2));

            String response = this.syncHttpPost(
                    "http://127.0.0.1:12345/json/submit", payload);
            ...
            response = this.syncHttpPost("http://127.0.0.1:12345/json/submit",
                    payload);
            ...
            Assert.assertEquals("UID8", UserIdTestCase.TEST_ID_1,
            ...
            Assert.assertEquals("UID13", UserIdTestCase.TEST_ID_2,
                    responseJson.get("payload"));
            ...
            Assert.assertEquals("UID18", UserIdTestCase.TEST_ID_1,
                    responseJson.get("payload"));
