...
public class RepeatingTriggerTestCase extends RobotTestCase 
{
	...
	public void test() 
	{
		...
		Assert.assertEquals("RDT1", "", persisted.unwrap()); // TODO: Unwrap at scripting engine?
		...
		try 
		{
			...
			triggerDef.put(Trigger.ACTION, "PurpleRobot.playDefaultTone(); PurpleRobot.testLog('Date Test: Repeat Fired!'); PurpleRobot.persistString('repeat-test-token', PurpleRobot.fetchString('repeat-test-token') + 'a'); PurpleRobot.vibrate('SOS');");
