...
public class WekaTreeModelTestCase extends RobotTestCase {
    ...
    public void test() {
        ...
        try {
            ...
            Assert.assertEquals("WTT001", "alone",
                    prediction.get(LeafNode.PREDICTION));
            ...
            // prediction.get(LeafNode.PREDICTION) + " // " +
            // prediction.get(LeafNode.ACCURACY) + ".");
            Assert.assertEquals("WTT002", "alone",
                    prediction.get(LeafNode.PREDICTION));
            ...
            // prediction.get(LeafNode.PREDICTION) + " // " +
            // prediction.get(LeafNode.ACCURACY) + ".");
            Assert.assertEquals("WTT003", "partner",
                    prediction.get(LeafNode.PREDICTION));

            world.put("wifiaccesspointsprobe_current_ssid", "0x");
            world.put("wifiaccesspointsprobe_access_point_count",
                    Double.valueOf(20));
            prediction = node.fetchPrediction(world);
            // System.out.println("Expect strangers. Got " +
            // prediction.get(LeafNode.PREDICTION) + " // " +
            // prediction.get(LeafNode.ACCURACY) + ".");
            Assert.assertEquals("WTT004", "strangers",
                    prediction.get(LeafNode.PREDICTION));
            ...
            // prediction.get(LeafNode.PREDICTION) + " // " +
            // prediction.get(LeafNode.ACCURACY) + ".");
            Assert.assertEquals("WTT005", "acquaintances",
                    prediction.get(LeafNode.PREDICTION));

            world.put(
                    "runningsoftwareproberunning_tasks_running_tasks_package_name",
                    "comandroidlauncher");
            prediction = node.fetchPrediction(world);
            // System.out.println("Expect alone. Got " +
            // prediction.get(LeafNode.PREDICTION) + " // " +
            // prediction.get(LeafNode.ACCURACY) + ".");
            Assert.assertEquals("WTT006", "alone",
                    prediction.get(LeafNode.PREDICTION));
