...
{
	/**
	 * Thrown when a tree is evaluated and a value is not available to match
	 * any of the associated conditions.
	 */
	...
	public static enum Operation 
	{
		...
		STARTS_WITH,
		ENDS_WITH,
		DEFAULT // Always passes. Typically used as a catch-all for missing
		        // data scenarios. 
	}
	...
	public static class Condition
	{
		 ...
		 * Builds a condition.
		 * 
		 * @param op Test operation.
		 * @param feature	Key of the feature to test.
		 * @param value	Test value or threshold.
		 * @param priority Priority of the condition. Conditions with higher
		 *                 priority are evaluated before those with lower
		 *                 priorities.
		 * @param node TreeNode associated with fulfilling this condition.
		 */
		 ...
		 * 
		 * @param features Key-value pairs representing the state of the world.
		 * @return True if the features fulfills this condition, false otherwise.
		 * 
		 * @throws TreeNodeException Thrown on error evaluating the coditions.
		 */
		 ...
		 * @throws TreeNode.TreeNodeException Thrown if no node is associated with
		 *                                    this condition.
		 */
	 ...
	 * @param value Test or threshold.
	 * @param priority Priority of this test.
	 * @param node Associated TreeNode on passing of test.
	 */
	...
	/**
	 * Returns the prediction generated bt this node's descendants that map to the
	 * values in features.
	 * 
