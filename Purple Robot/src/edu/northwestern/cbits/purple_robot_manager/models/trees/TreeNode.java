...
public abstract class TreeNode 
{
	 ...
	 * the model
	 * 
	 * @param features Features representing the current state of the world.
	 * 
	 * @return Map containing the prediction generated by the model as well as 
	 *         any associated metadata.
	 *         
	 * @throws TreeNodeException Thrown if an error occurs evaluating the model.
	 *                           Refer to the exception's message for details.
	 */
	 ...
	 * applicable.
	 * 
	 * @param indent Number of levels to indent the tree. 1 level corresponds to
	 *               2 spaces.
	 *               
	 * @return String representation of the tree suitable for human 
	 *         interpretation.
	 *         
	 * @throws TreeNodeException Thrown on an error encountered evaluating the
	 *                           tree. 
	 */
