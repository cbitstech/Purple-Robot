...
public class WekaJ48TreeParser extends TreeNodeParser {
    ...
    private TreeNode treeForNode(String id) throws TreeNodeException {
                        ...
                        if (edgeLine.startsWith(id + "->")) {
                            ...
                            if ("=".equals(comparison)) {
                                if ("?".equals(value)) {
                                    ...
                                    branch.addCondition(Operation.DEFAULT,
                                            feature, value,
                                            Condition.LOWEST_PRIORITY, nextNode);
                                } else {
                                    ...
                                    branch.addCondition(Operation.EQUALS,
                                            feature, value,
                                ...
                                if ("<=".equals(comparison))
                                    branch.addCondition(
                                            ...
                                            feature, Double.valueOf(value),
                                            Condition.DEFAULT_PRIORITY,
                                            nextNode);
                                else if (">".equals(comparison))
                                    branch.addCondition(Operation.MORE_THAN,
                                            feature, Double.valueOf(value),
                                            Condition.DEFAULT_PRIORITY,
                                            nextNode);
                                else if (">=".equals(comparison))
                                    branch.addCondition(
                                            Operation.MORE_THAN_OR_EQUAL_TO,
                                            feature, Double.valueOf(value),
                                            Condition.DEFAULT_PRIORITY,
                                            nextNode);
                                else if ("<".equals(comparison))
                                    branch.addCondition(Operation.LESS_THAN,
                                            feature, Double.valueOf(value),
                                            Condition.DEFAULT_PRIORITY,
                                            nextNode);
                            }
        ...
        throw new TreeNode.TreeNodeException(
                "Unable to find definition for node with ID '" + id + "'.");
    }
    ...
    private TreeNode leafNodeForLine(String line) {
        ...
        String remainder = labelTokens[1].substring(0,
                labelTokens[1].length() - 1);
        ...
        prediction.put(WekaJ48TreeParser.NUM_INSTANCES,
                Double.valueOf(coverage));
        prediction.put(WekaJ48TreeParser.NUM_INCORRECT,
                Double.valueOf(incorrect));
