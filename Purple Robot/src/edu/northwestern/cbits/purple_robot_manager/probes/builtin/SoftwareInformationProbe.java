...
public class SoftwareInformationProbe extends Probe {
    ...
    public boolean isEnabled(Context context) {
        ...
        if (super.isEnabled(context)) {
            ...
            if (prefs.getBoolean("config_probe_software_enabled",
                    SoftwareInformationProbe.DEFAULT_ENABLED)) {
                synchronized (this) {
                    long freq = Long.parseLong(prefs.getString(
                            "config_probe_software_frequency",
                    ...
                    if (now - this._lastCheck > freq) {
                        ...
                        bundle.putString(SoftwareInformationProbe.CODENAME,
                                Build.VERSION.CODENAME);
                        bundle.putString(SoftwareInformationProbe.INCREMENTAL,
                                Build.VERSION.INCREMENTAL);
                        bundle.putString(SoftwareInformationProbe.RELEASE,
                                Build.VERSION.RELEASE);
                        bundle.putInt(SoftwareInformationProbe.SDK_INT,
                        ...
                        try {
                            ...
                            for (ApplicationInfo info : infos) {
                                try {
                                    ...
                                    appBundle.putString(
                                            SoftwareInformationProbe.APP_NAME,
                                            info.loadLabel(pm).toString());
                                    appBundle
                                            .putString(
                                                    SoftwareInformationProbe.PACKAGE_NAME,
                                                    info.packageName);
                            ...
                            bundle.putParcelableArrayList(
                                    ...
                                    installed);
                            bundle.putInt(
                                    SoftwareInformationProbe.INSTALLED_APP_COUNT,
                                    installed.size());
    ...
    public String summarizeValue(Context context, Bundle bundle) {
        ...
        int count = (int) bundle
                .getDouble(SoftwareInformationProbe.INSTALLED_APP_COUNT);

        return String.format(
                context.getResources().getString(
                        R.string.summary_software_info_probe), release, count);
    }
    ...
    public Bundle formattedBundle(Context context, Bundle bundle) {
        ...
        formatted.putBundle(
                String.format(context
                        .getString(R.string.display_installed_apps_title),
                        count), appsBundle);
        formatted.putString(
                context.getString(R.string.display_android_version_title),
                bundle.getString(SoftwareInformationProbe.RELEASE));
    ...
    public Map<String, Object> configuration(Context context) {
        ...
        long freq = Long.parseLong(prefs.getString(
                "config_probe_software_frequency", Probe.DEFAULT_FREQUENCY));
    ...
    public void updateFromMap(Context context, Map<String, Object> params) {
        ...
        if (params.containsKey(Probe.PROBE_FREQUENCY)) {
            ...
            if (frequency instanceof Long) {
                ...
                e.putString("config_probe_software_frequency",
                        frequency.toString());
                e.commit();
            }
        }
