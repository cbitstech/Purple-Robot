...
public class FacebookProbe extends Probe
{
    ...
    public boolean isEnabled(final Context context)
    {
        ...
        if (super.isEnabled(context))
        {
            ...
            if (prefs.getBoolean("config_probe_facebook_enabled", FacebookProbe.DEFAULT_ENABLED))
            {
                synchronized (this)
                {
                    long freq = Long.parseLong(prefs.getString("config_probe_facebook_frequency",
                            Probe.DEFAULT_FREQUENCY));
                    final boolean doHash = prefs.getBoolean("config_probe_facebook_encrypt_data",
                            FacebookProbe.DEFAULT_ENCRYPT);
                    ...
                    if (now - this._lastCheck > freq)
                    {
                        ...
                        if (token != null && token.trim().length() > 0)
                        {
                            ...
                            AccessToken accessToken = AccessToken.createFromExistingAccessToken(token, null, null,
                                    null, null);
                                    ...
                                    Request friendRequest = Request.newMyFriendsRequest(session,
                                            new Request.GraphUserListCallback()
                                            {
                                                public void onCompleted(List<GraphUser> users, Response response)
                                                {
                                                    ...
                                                    final long mostRecent = prefs.getLong(
                                                            "config_probe_facebook_recent", 0);
                                                    ...
                                                    try
                                                    {
                                                        ...
                                                        Request statuses = new Request(session, "/me/statuses", null,
                                                                HttpMethod.GET, new Request.Callback()
                                                                {
                                                                    ...
                                                                    public void onCompleted(Response response)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            GraphObjectList<GraphObject> rawPosts = obj
                                                                                    .getPropertyAsList("data",
                                                                                            GraphObject.class);
                                                                            ...
                                                                            Request posts = new Request(session,
                                                                                    ...
                                                                                    new Request.Callback()
                                                                                    {
                                                                                                ...
                                                                                                Response response)
                                                                                        {
                                                                                            try
                                                                                            {
                                                                                                            ...
                                                                                                            if (postTime > mostRecent)
                                                                                                            {
                                                                                                                ...
                                                                                                                if (o != null)
                                                                                                                {
                                                                                                                    ...
                                                                                                                    eventBundle
                                                                                                                            .putString(
                                                                                                                                    "PROBE",
                                                                                                                                    FacebookEventsProbe.PROBE_NAME);
                                                                                                                    eventBundle
                                                                                                                            .putLong(
                                                                                                                                    "TIMESTAMP",
                                                                                                                                    postTime / 1000);
                                                                                                ...
                                                                                                Editor e = prefs.edit();
                                                                                                e.putLong(
                                                                                                        "config_probe_facebook_recent",
                                                                                                        newRecent);
                                                                                                e.commit();

                                                                                                bundle.putInt(
                                                                                                        FacebookProbe.HOUR_COUNT,
                                                                                                        hour);
    ...
    public String summarizeValue(Context context, Bundle bundle)
    {
        ...
        return String
                .format(context.getResources().getString(R.string.facebook_count_desc), (int) count, (int) friends);
    }
    ...
    public void updateFromMap(Context context, Map<String, Object> params)
    {
        ...
        if (params.containsKey(Probe.PROBE_FREQUENCY))
        {
            ...
            if (frequency instanceof Long)
            {
                ...
                e.putString("config_probe_facebook_frequency", frequency.toString());
                e.commit();
            }
        }
        ...
        if (params.containsKey(Probe.ENCRYPT_DATA))
        {
            ...
            if (encrypt instanceof Boolean)
            {
                ...
                e.putBoolean("config_probe_facebook_encrypt_data", encryptBoolean.booleanValue());
                e.commit();
            }
        }
    }
