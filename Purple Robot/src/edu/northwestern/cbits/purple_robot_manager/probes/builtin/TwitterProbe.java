...
public class TwitterProbe extends Probe {
    ...
    public boolean isEnabled(final Context context) {
        ...
        if (super.isEnabled(context)) {
            ...
            if (prefs.getBoolean("config_probe_twitter_enabled",
                    TwitterProbe.DEFAULT_ENABLED)) {
                synchronized (this) {
                    long freq = Long.parseLong(prefs.getString(
                            "config_probe_twitter_frequency",
                            Probe.DEFAULT_FREQUENCY));
                    final boolean doEncrypt = prefs.getBoolean(
                            "config_probe_twitter_encrypt_data",
                    ...
                    if (now - this._lastCheck > freq) {
                        ...
                        this._token = prefs.getString("oauth_twitter_token",
                                null);
                        this._secret = prefs.getString("oauth_twitter_secret",
                                null);

                        final String title = context
                                .getString(R.string.title_twitter_check);
                        final SanityManager sanity = SanityManager
                                .getInstance(context);

                        if (this._token == null || this._secret == null) {
                            String message = context
                                    .getString(R.string.message_twitter_check);
                            ...
                            Runnable r = new Runnable() {
                                public void run() {
                                    try {
                                        ...
                                        for (int i = (tweets.length() - 1); i >= 0; i--) {
                                            ...
                                            if (tweetTime > mostRecent) {
                                                ...
                                                eventBundle
                                                        .putString(
                                                                "LANGUAGE",
                                                                tweet.getString("lang"));
                                                eventBundle
                                                        .putInt("FAVORITE_COUNT",
                                                                tweet.getInt("favorite_count"));
                                                eventBundle
                                                        .putInt("RETWEET_COUNT",
                                                                tweet.getInt("retweet_count"));
                                                eventBundle.putLong("TWEET_ID",
                                                        tweet.getLong("id"));
                                                eventBundle
                                                        .putString(
                                                                "SOURCE",
                                        ...
                                        Editor e = prefs.edit();
                                        e.putLong("config_twitter_most_recent",
    ...
    public Map<String, Object> configuration(Context context) {
        ...
        long freq = Long.parseLong(prefs.getString(
                "config_probe_twitter_frequency", Probe.DEFAULT_FREQUENCY));
        map.put(Probe.PROBE_FREQUENCY, freq);

        boolean hash = prefs.getBoolean("config_probe_twitter_encrypt_data",
                TwitterProbe.DEFAULT_ENCRYPT);
    ...
    public void updateFromMap(Context context, Map<String, Object> params) {
        ...
        if (params.containsKey(Probe.PROBE_FREQUENCY)) {
            ...
            if (frequency instanceof Long) {
                ...
                e.putString("config_probe_twitter_frequency",
                        frequency.toString());
                e.commit();
            }
        }
        ...
        if (params.containsKey(Probe.ENCRYPT_DATA)) {
            ...
            if (encrypt instanceof Boolean) {
                ...
                e.putBoolean("config_probe_twitter_encrypt_data",
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        ...
                        activity.runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(
                                        activity,
                                        activity.getString(R.string.toast_twitter_logout),
