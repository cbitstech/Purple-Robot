...
public class CommunicationEventProbe extends Probe {
    ...
    public boolean isEnabled(Context context) {
        ...
        if (super.isEnabled(context)) {
            ...
            if (prefs.getBoolean("config_probe_communication_event_enabled",
                    CommunicationEventProbe.DEFAULT_ENABLED)) {
                synchronized (this) {
                    long freq = Long.parseLong(prefs.getString(
                            "config_probe_communication_event_frequency",
                            Probe.DEFAULT_FREQUENCY));
                    boolean doHash = prefs.getBoolean(
                            "config_probe_communication_event_hash_data",
                            Probe.DEFAULT_HASH_DATA);

                    if (now - this._lastCheck > freq) {
                        long mostRecent = prefs.getLong(
                                "config_probe_communication_event_recent", 0);
                        ...
                        try {
                            ...
                            while (c.moveToNext()) {
                                ...
                                bundle.putString(CommunicationEventProbe.TYPE,
                                        CommunicationEventProbe.TYPE_PHONE);
                                ...
                                bundle.putString(CommunicationEventProbe.NAME,
                                        numberName);
                                bundle.putString(
                                        CommunicationEventProbe.NUMBER,
                                        phoneNumber);
                                ...
                                bundle.putLong(
                                        CommunicationEventProbe.TIMESTAMP,
                                        callTime);
                                ...
                                bundle.putLong(
                                        CommunicationEventProbe.DURATION,
                                        c.getLong(c
                                ...
                                if (callType == Calls.OUTGOING_TYPE)
                                    bundle.putString(
                                            CommunicationEventProbe.DIRECTION,
                                    ...
                                    bundle.putString(
                                            CommunicationEventProbe.DIRECTION,
                                            CommunicationEventProbe.MISSED);
                                else
                                    bundle.putString(
                                            CommunicationEventProbe.DIRECTION,
                                            CommunicationEventProbe.UNKNOWN);
                            ...
                            while (c.moveToNext()) {
                                ...
                                bundle.putString(CommunicationEventProbe.TYPE,
                                        CommunicationEventProbe.TYPE_SMS);
                            ...
                            while (c.moveToNext()) {
                                ...
                                boolean retrieve = prefs
                                        .getBoolean(
                                                "config_probe_communication_event_retrieve_data",
                                                CommunicationEventProbe.DEFAULT_RETRIEVE);
                                boolean encrypt = prefs
                                        .getBoolean(
                                ...
                                if (retrieve) {
                                    ...
                                    bundle.putString(
                                            CommunicationEventProbe.MESSAGE_BODY,
                                            body);
                                }
                        ...
                        Editor e = prefs.edit();
                        e.putLong("config_probe_communication_event_recent",
                                newRecent);
                        e.commit();
                    }
                }
    ...
    public String summarizeValue(Context context, Bundle bundle) {
        ...
        if (CommunicationEventProbe.TYPE_PHONE.equals(type))
            type = context.getResources().getString(
                    R.string.summary_communication_events_phone_type);
        else
            type = context.getResources().getString(
                    R.string.summary_communication_events_sms_type);

        long timestamp = (long) bundle
                .getDouble(CommunicationEventProbe.TIMESTAMP);
        ...
        return String.format(
                context.getResources().getString(
                        R.string.summary_communication_events_probe), type,
                name, format.format(new Date(timestamp)));
    }
    ...
    public void updateFromMap(Context context, Map<String, Object> params) {
        ...
        if (params.containsKey(Probe.PROBE_FREQUENCY)) {
            ...
            if (frequency instanceof Long) {
                ...
                e.putString("config_probe_communication_event_frequency",
                        frequency.toString());
                e.commit();
            }
        }
        ...
        if (params.containsKey(Probe.HASH_DATA)) {
            ...
            if (hash instanceof Boolean) {
                ...
                e.putBoolean("config_probe_communication_event_hash_data",
    ...
    public String summary(Context context) {
        return context
                .getString(R.string.summary_communication_event_probe_desc);
    }
            ...
            public boolean onPreferenceChange(Preference arg0, Object newValue) {
                ...
                if (b) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(
                            activity);
                    builder = builder
                            .setTitle(R.string.config_probe_communication_retrieve_warning_title);
                    builder = builder
                            .setMessage(R.string.config_probe_communication_retrieve_warning);
                    builder = builder.setPositiveButton(
                            R.string.button_continue, null);
