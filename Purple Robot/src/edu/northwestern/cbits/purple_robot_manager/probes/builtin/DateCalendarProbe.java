...
public class DateCalendarProbe extends Probe {
    ...
    public boolean isEnabled(Context context) {
        ...
        if (super.isEnabled(context)) {
            ...
            if (prefs.getBoolean("config_probe_date_calendar_enabled",
                    DateCalendarProbe.DEFAULT_ENABLED)) {
                if (now - this._lastCheck > Long.parseLong(prefs.getString(
                        "config_probe_date_calendar_frequency",
                    ...
                    bundle.putInt(DateCalendarProbe.DAY_OF_MONTH,
                            calendar.get(Calendar.DAY_OF_MONTH));
                    bundle.putInt(DateCalendarProbe.DAY_OF_WEEK,
                            calendar.get(Calendar.DAY_OF_WEEK));
                    bundle.putInt(DateCalendarProbe.DAY_OF_WEEK_IN_MONTH,
                            calendar.get(Calendar.DAY_OF_WEEK_IN_MONTH));
                    bundle.putInt(DateCalendarProbe.DAY_OF_YEAR,
                            calendar.get(Calendar.DAY_OF_YEAR));
                    bundle.putInt(DateCalendarProbe.DST_OFFSET,
                            calendar.get(Calendar.DST_OFFSET));
                    bundle.putInt(DateCalendarProbe.HOUR_OF_DAY,
                            calendar.get(Calendar.HOUR_OF_DAY));
                    bundle.putInt(DateCalendarProbe.WEEK_OF_MONTH,
                            calendar.get(Calendar.WEEK_OF_MONTH));
                    bundle.putInt(DateCalendarProbe.WEEK_OF_YEAR,
                            calendar.get(Calendar.WEEK_OF_YEAR));
                    bundle.putInt(DateCalendarProbe.MONTH,
                            calendar.get(Calendar.MONTH) + 1);
                    bundle.putInt(DateCalendarProbe.MINUTE,
    ...
    public String summarizeValue(Context context, Bundle bundle) {
        ...
        return String
                .format(context.getResources().getString(
                        R.string.summary_date_calendar_probe), month, week, day);
    }
