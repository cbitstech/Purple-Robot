...
public class TemperatureProbeBasicStatisticsFeature extends
        UnivariateContinuousProbeFeature {
    ...
    public String summary(Context context) {
        return context
                .getString(R.string.summary_temperature_statistics_feature_desc);
    }
