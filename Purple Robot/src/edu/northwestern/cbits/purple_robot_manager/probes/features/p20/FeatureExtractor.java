...
public class FeatureExtractor {
    ...
    public static enum Feature {
        ACC_NUM_SAMPLES, ACC_MEAN, ACCX_MEAN, ACCY_MEAN, ACCZ_MEAN, ACC_MEAN_ABS, ACCX_MEAN_ABS, ACCY_MEAN_ABS, ACCZ_MEAN_ABS, ACCX_STD, ACCY_STD, ACCZ_STD, ACCX_SKEW, ACCY_SKEW, ACCZ_SKEW, ACCX_KURT, ACCY_KURT, ACCZ_KURT, ACCX_DIFF_MEAN, ACCY_DIFF_MEAN, ACCZ_DIFF_MEAN, ACCX_DIFF_STD, ACCY_DIFF_STD, ACCZ_DIFF_STD, ACCX_DIFF_SKEW, ACCY_DIFF_SKEW, ACCZ_DIFF_SKEW, ACCX_DIFF_KURT, ACCY_DIFF_KURT, ACCZ_DIFF_KURT, ACCX_MAX, ACCY_MAX, ACCZ_MAX, ACCX_MIN, ACCY_MIN, ACCZ_MIN, ACCX_MAX_ABS, ACCY_MAX_ABS, ACCZ_MAX_ABS, ACCX_MIN_ABS, ACCY_MIN_ABS, ACCZ_MIN_ABS, ACCX_RMS, ACCY_RMS, ACCZ_RMS, ACC_CROSS_XY, ACC_CROSS_YZ, ACC_CROSS_ZX, ACC_CROSS_XY_ABS, ACC_CROSS_YZ_ABS, ACC_CROSS_ZX_ABS, ACC_CROSS_XY_NORM, ACC_CROSS_YZ_NORM, ACC_CROSS_ZX_NORM, ACC_CROSS_XY_NORM_ABS, ACC_CROSS_YZ_NORM_ABS, ACC_CROSS_ZX_NORM_ABS, ACCX_FFT_1, ACCX_FFT_2, ACCX_FFT_3, ACCX_FFT_4, ACCX_FFT_5, ACCX_FFT_6, ACCX_FFT_7, ACCX_FFT_8, ACCX_FFT_9, ACCX_FFT_10, ACCY_FFT_1, ACCY_FFT_2, ACCY_FFT_3, ACCY_FFT_4, ACCY_FFT_5, ACCY_FFT_6, ACCY_FFT_7, ACCY_FFT_8, ACCY_FFT_9, ACCY_FFT_10, ACCZ_FFT_1, ACCZ_FFT_2, ACCZ_FFT_3, ACCZ_FFT_4, ACCZ_FFT_5, ACCZ_FFT_6, ACCZ_FFT_7, ACCZ_FFT_8, ACCZ_FFT_9, ACCZ_FFT_10, ACCX_HIST1, ACCX_HIST2, ACCX_HIST3, ACCX_HIST4, ACCX_HIST5, ACCX_HIST6, ACCY_HIST1, ACCY_HIST2, ACCY_HIST3, ACCY_HIST4, ACCY_HIST5, ACCY_HIST6, ACCZ_HIST1, ACCZ_HIST2, ACCZ_HIST3, ACCZ_HIST4, ACCZ_HIST5, ACCZ_HIST6, GYR_NUM_SAMPLES, GYR_MEAN, GYRX_MEAN, GYRY_MEAN, GYRZ_MEAN, GYR_MEAN_ABS, GYRX_MEAN_ABS, GYRY_MEAN_ABS, GYRZ_MEAN_ABS, GYRX_STD, GYRY_STD, GYRZ_STD, GYRX_SKEW, GYRY_SKEW, GYRZ_SKEW, GYRX_KURT, GYRY_KURT, GYRZ_KURT, GYRX_DIFF_MEAN, GYRY_DIFF_MEAN, GYRZ_DIFF_MEAN, GYRX_DIFF_STD, GYRY_DIFF_STD, GYRZ_DIFF_STD, GYRX_DIFF_SKEW, GYRY_DIFF_SKEW, GYRZ_DIFF_SKEW, GYRX_DIFF_KURT, GYRY_DIFF_KURT, GYRZ_DIFF_KURT, GYRX_MAX, GYRY_MAX, GYRZ_MAX, GYRX_MIN, GYRY_MIN, GYRZ_MIN, GYRX_MAX_ABS, GYRY_MAX_ABS, GYRZ_MAX_ABS, GYRX_MIN_ABS, GYRY_MIN_ABS, GYRZ_MIN_ABS, GYRX_RMS, GYRY_RMS, GYRZ_RMS, GYR_CROSS_XY, GYR_CROSS_YZ, GYR_CROSS_ZX, GYR_CROSS_XY_ABS, GYR_CROSS_YZ_ABS, GYR_CROSS_ZX_ABS, GYR_CROSS_XY_NORM, GYR_CROSS_YZ_NORM, GYR_CROSS_ZX_NORM, GYR_CROSS_XY_NORM_ABS, GYR_CROSS_YZ_NORM_ABS, GYR_CROSS_ZX_NORM_ABS, GYRX_FFT_1, GYRX_FFT_2, GYRX_FFT_3, GYRX_FFT_4, GYRX_FFT_5, GYRX_FFT_6, GYRX_FFT_7, GYRX_FFT_8, GYRX_FFT_9, GYRX_FFT_10, GYRY_FFT_1, GYRY_FFT_2, GYRY_FFT_3, GYRY_FFT_4, GYRY_FFT_5, GYRY_FFT_6, GYRY_FFT_7, GYRY_FFT_8, GYRY_FFT_9, GYRY_FFT_10, GYRZ_FFT_1, GYRZ_FFT_2, GYRZ_FFT_3, GYRZ_FFT_4, GYRZ_FFT_5, GYRZ_FFT_6, GYRZ_FFT_7, GYRZ_FFT_8, GYRZ_FFT_9, GYRZ_FFT_10, GYRX_HIST1, GYRX_HIST2, GYRX_HIST3, GYRX_HIST4, GYRX_HIST5, GYRX_HIST6, GYRY_HIST1, GYRY_HIST2, GYRY_HIST3, GYRY_HIST4, GYRY_HIST5, GYRY_HIST6, GYRZ_HIST1, GYRZ_HIST2, GYRZ_HIST3, GYRZ_HIST4, GYRZ_HIST5, GYRZ_HIST6, PROCESSING_TIME
    }

    public FeatureExtractor(long windowSize, List<Feature> features,
            int dimensions) {
    ...
    public Map<Feature, Double> extractFeatures(Clip clp) {
        ...
        if (this._hasNormCross) {
            ...
            if (this._dimensions == 3) {
                ...
                case Clip.ACCELEROMETER:
                    ...
                    features.put(Feature.ACC_CROSS_XY_NORM_ABS,
                            Math.abs(crossNorm[0]));
                    features.put(Feature.ACC_CROSS_YZ_NORM_ABS,
                            Math.abs(crossNorm[1]));
                    features.put(Feature.ACC_CROSS_ZX_NORM_ABS,
                            Math.abs(crossNorm[2]));
                ...
                case Clip.GYROSCOPE:
                    ...
                    features.put(Feature.GYR_CROSS_XY_NORM_ABS,
                            Math.abs(crossNorm[0]));
                    features.put(Feature.GYR_CROSS_YZ_NORM_ABS,
                            Math.abs(crossNorm[1]));
                    features.put(Feature.GYR_CROSS_ZX_NORM_ABS,
                            Math.abs(crossNorm[2]));
        ...
        /*
         * if (hasFFT) Complex[] fft_values = fft.transform(signal,
