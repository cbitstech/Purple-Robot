    ...
    public JSONObject execute(Context context) {
        ...
        try {
            if (JSONCommand.STATUS_OK.equals(result.get(JSONCommand.STATUS))) {
                String key = this._arguments
                        .getString(PersistStringCommand.KEY);
                String value = this._arguments
                        .getString(PersistStringCommand.VALUE);
                ...
                if (this._arguments.has(PersistStringCommand.ENCRYPTED))
                    doEncrypt = this._arguments
                            .getBoolean(PersistStringCommand.ENCRYPTED);
