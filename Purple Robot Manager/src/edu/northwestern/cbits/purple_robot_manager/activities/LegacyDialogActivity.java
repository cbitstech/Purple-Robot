...
public class LegacyDialogActivity extends Activity
{
	...
	private static ArrayList<LegacyDialogActivity> _dialogStack = new ArrayList<LegacyDialogActivity>();
	...
	protected void onCreate(Bundle savedInstanceState)
    {
        ...
        LegacyDialogActivity._dialogStack.add(this);

        while (stackSize > 0 && LegacyDialogActivity._dialogStack.size() > stackSize)
        {
        	LegacyDialogActivity activity = LegacyDialogActivity._dialogStack.remove(0);
	...
	protected void onDestroy ()
	{
		...
		LegacyDialogActivity._dialogStack.remove(this);
	}
	...
	protected void onPause()
	{
        ...
        final String title = intent.getStringExtra(LegacyDialogActivity.DIALOG_TITLE);
        final String message = intent.getStringExtra(LegacyDialogActivity.DIALOG_MESSAGE);
	...
	protected void onResume()
	{
		...
		final LegacyDialogActivity me = this;
        ...
        final String confirmScript = intent.getStringExtra(LegacyDialogActivity.DIALOG_CONFIRM_SCRIPT);
        ...
        confirmButton.setText(intent.getStringExtra(LegacyDialogActivity.DIALOG_CONFIRM_BUTTON));
        ...
        if (intent.hasExtra(LegacyDialogActivity.DIALOG_CANCEL_BUTTON))
        {
			cancelButton.setText(intent.getStringExtra(LegacyDialogActivity.DIALOG_CANCEL_BUTTON));

            if (intent.hasExtra(LegacyDialogActivity.DIALOG_CANCEL_SCRIPT))
            {
	            final String cancelScript = intent.getStringExtra(LegacyDialogActivity.DIALOG_CANCEL_SCRIPT);
