...
public class GravityProbe extends ContinuousProbe implements SensorEventListener
{
	...
	public long getFrequency()
	{
		...
		return Long.parseLong(prefs.getString("config_probe_gravity_built_in_frequency", ContinuousProbe.DEFAULT_FREQUENCY));
	}
	...
	public boolean isEnabled(Context context)
	{
        ...
        if (super.isEnabled(context))
        {
        	...
        	{
				int frequency = Integer.parseInt(prefs.getString("config_probe_gravity_built_in_frequency", ContinuousProbe.DEFAULT_FREQUENCY));
	...
	protected boolean passesThreshold(SensorEvent event)
	{
		...
		if (now - this.lastThresholdLookup > 5000)
		{
			...
			this.lastThreshold = Double.parseDouble(prefs.getString("config_probe_gravity_threshold", GravityProbe.DEFAULT_THRESHOLD));
